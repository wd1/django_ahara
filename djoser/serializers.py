...
from djoser.compat import get_user_email, get_user_email_field_name, get_user_phone, get_user_phone_field_name
    ...
    def get_user(self, is_active=True):
        try:
            user = User._default_manager.get(
                is_active=is_active,
                **{self.phone_field: self.data.get(self.phone_field, "")},
            )
...
class SendSmsResetSerializer(serializers.Serializer, UserFunctionsMixin):
    default_error_messages = {
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.phone_field = get_user_phone_field_name(User)
